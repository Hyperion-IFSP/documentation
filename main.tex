...
Segundo as autoras \citeonline{mariacristina2008}, o consumo de um medicamento ou o acompanhamento de consultas de rotina podem se tornar algo supérfluo na rotina de um paciente que os realiza com frequência, podendo acarretar em um esquecimento de tais compromissos. 

Em paralelo, foi realizada uma pesquisa com o público-geral para definição de um escopo. No formato de um formulário online e com 45 respostas, aproximadamente 71\% dos participantes utilizam pouco ou muito pouco de serviços tecnológicos de saúde; dos que utilizam, 63\% relatam não corresponder às suas expectativas. Cerca de 62\% dos participantes relatam possuir grandes dificuldades em lembrar de datas de consultas, e 81\% relatam problemas no horário de consumo de remédios. O questionário aplicado nesta etapa se encontra no \autoref{pesquisas}.

Desta forma, após a síntese destes dados, pode-se estabelecer uma lacuna que demonstra a utilidade deste sistema, priorizando acessibilidade a um sistema de qualidade e visando mitigar as necessidades dos usuários de um melhor gerenciamento dos tratamentos de seus pacientes — sejam relacionados aos medicamentos, as consultas ou quaisquer outras informações pertinentes a estes prontuários — a fim de manter a saúde destes bem condicionadas e supervisionadas.
...
A telemedicina não é destinada à substituição do médico, mas sim como uma ferramenta assistiva que otimiza processos para pacientes e profissionais. Desta forma, se apresenta também como um instrumento de democratização da saúde: enquanto muitas regiões carecem de infraestrutura médica física, a tecnologia possui maior alcançabilidade para áreas remotas ou isoladas, conforme apontam \citeonline{Schaefer2023telemedicina}.
...
Telemonitoramento, segundo \citeonline{petraroli2018biotelemetria}, é uma subárea da medicina, que permite o monitoramento e gerenciamento de dispositivos e sensores médicos via software para aumentar a eficiência dos processos. Em seu artigo, foi analisado a plataforma de monitoramento geriátrico de doenças crônicas \textit{Virtual Monitor} e seu potencial de investimento no mercado atual da telemedicina. A autora defende que sistemas como o de pesquisa possuem um atrativo comercial elevado no cenário atual somente se têm como foco a inovação de recursos de sustentabilidade e na competitividade. Diz, ainda, que para simplificar e escalar o acompanhamento de idosos, é de extrema necessidade uma solução que envolva cuidado centrado nas pessoas, viabilizando o mercado de cuidado suplementar.
...
O Ministério da Saúde e a Agência Nacional de Vigilância Sanitária já definiram normas que categorizam idosos não-autônomos em três termos de dependência: grau I, totalmente independentes; grau II, que necessitam de auxílio em até três atividades básicas diárias; grau III, que necessitam auxílio em todas as tarefas de autocuidado. É também posto um limite para cuidadores de idosos: em uma jornada de trabalho de oito horas diárias e cinco dias por semana, o profissional de uma instituição de cuidado pode auxiliar até 20 idosos com grau de dependência I, até 10 idosos com grau de dependência II ou 6 idosos com grau de dependência III \cite{ministeriosaude2021ilpi}.

Na pesquisa de \citeonline{nunes2018sabe}, que inclui um grupo de 359 cuidadores do município de São Paulo - SP, a maioria dos cuidadores era familiar, do sexo feminino, com média de idade de 53,9 anos, percebe-se que mesmo com a imposição de limites, ainda existe uma sobrecarga para estes profissionais.

Fatores como a disfunção familiar (incapacidade de uma família cobrir as necessidades básicas de um indivíduo como apoio emocional e financeiro) e o excesso de trabalho durante longas horas se destacaram por contribuir com o estresse do profissional de cuidado, que somam mais de um terço do grupo de pesquisa. Os cuidadores familiares, mesmo tendo uma grande intimidade com o dependente, ainda sofrem com situações que exigem uma parcela próxima ao total de seu tempo. 
...
Desta forma, surge um apelo principalmente às instituições públicas, pelo fornecimento de recursos suficientes para a manutenção pessoal de profissionais de cuidado e seus serviços, a fim de possibilitar o exercício adequado e apropriado de suas atividades.
...
A coleta ocorreu em duas etapas. As escalas utilizadas incluíram perguntas de múltipla escolha, caixas de seleção para opiniões quantitativas e campos abertos para coleta de opiniões qualitativas. A primeira pesquisa contou com um grupo de 34 pessoas do público comum, e a segunda teve 10 profissionais cuidadores de idosos.

\subsubsection{Pesquisa com o Público Geral}
...
\subsubsection{Pesquisa com o Público-alvo}
...
\footnote{Seção da terapêutica que se dedica ao estudo da dosagem certa dos medicamentos. Indicação da dosagem certa (adequada) de um medicamento tendo em conta os vários casos em que o mesmo pode ser prescrito.}, 
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1.0\linewidth]{assets/figuras/diagrama-casos-uso.jpeg}
