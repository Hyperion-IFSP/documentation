...
\begin{resumo1} 
  ...
  a lembrar de seus horários de consumo e a monitorar o uso/estoque deles.
...
A saúde dos dias de hoje é em sua maioria amparada, e muitas vezes serve de motivação para a tecnologia mais atual. Estudos mostram que esses serviços estão em constante evolução e a cada ano sendo mais acessíveis e utilizados por ambos os grupos de médicos e de pacientes.
...
O uso de aplicações para o auxílio geral de seus tratamentos é algo vital para estes grupos. É, também, uma ferramenta útil para pacientes não idosos portadores de doenças crônicas como doenças do coração, diabetes, hipertensão, entre outros. Segundo \citeonline{clarisse2016}, a longo prazo, poucos métodos de memorização própria se mantêm efetivos, e muitas vezes são esquecidos.
