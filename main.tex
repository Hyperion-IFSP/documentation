...
A coleta ocorreu em duas etapas. Na primeira, para um público não direcionado por meio das redes sociais e grupos comunitários, com o intuito de obter uma visão ampliada sobre o tema. Na segunda etapa, os dados foram aprofundados por meio de pesquisas direcionadas à profissionais da área abordada. O \autoref{pesquisas} traz uma descrição das perguntas feitas.

\subsection{Análise de Dados}

A partir dos dados de ambas as pesquisas, foi constatado a lacuna de uma aplicação que sirva para o público de cuidadores de idosos, como visto na \autoref{pergunta6}. Dos profissionais ouvidos, 50\% trabalham como cuidadores sendo 40\% em domicílio particular e 30\% em casas de repouso. As atividades mais comuns realizadas na rotina com os idosos incluem: administração de medicamentos, monitoramento de sinais vitais e acompanhamento em consultas. Nenhum dos entrevistados utilizam algum aplicativo ou sistema para tal controle, registrando dados sensíveis como esses em papéis e lousas, e a figura \autoref{pergunta9} traz que 90\% dizem ter disposição para usar um aplicativo. 

\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{Figuras/utiliza-app.png}
    \caption{\label{pergunta6}Pergunta 6/10}
    \fonte{Autores.}
\end{figure}

\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{Figuras/utilizaria-app.png}
    \caption{\label{pergunta9}Pergunta 9/10}
    \fonte{Autores.}
\end{figure}
\clearpage
