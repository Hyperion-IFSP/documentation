As regras de negócio são fundamentais para garantir o correto funcionamento do sistema, assegurando que as operações atendam aos requisitos legais e funcionais. A seguir, apresentamos o \autoref{quadro_regras_negocio} com as principais regras de negócio definidas para o sistema de gestão de dependentes.
