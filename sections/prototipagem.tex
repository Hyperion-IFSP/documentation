...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.6\linewidth]{assets/prototipo/Avaliação Pos-consulta.png}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.6\linewidth]{assets/prototipo/Avaliação Pos-consulta (2).png}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.6\linewidth]{assets/prototipo/Agendamento - Consulta - Nome.png}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.8\linewidth]{assets/prototipo/Agenda.png}
	\caption{Calendário}
	\fonte{Autores.}
	\label{calendario}
\end{figure}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.6\linewidth]{assets/prototipo/Agendamento - Consulta - Nome (1).png}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.6\linewidth]{assets/prototipo/Agendamento - Consulta - Nome (2).png}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.6\linewidth]{assets/prototipo/Perfil de Usuário.png}
	\caption{Perfil}
	\fonte{Autores.}
	\label{perfil}
\end{figure}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.6\linewidth]{assets/prototipo/Configuracoes.png}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.6\linewidth]{assets/prototipo/Home.png}
