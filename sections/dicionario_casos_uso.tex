Os quadros a partir do \autoref{quadro_manter_perfil} até o \autoref{quadro_visualizar_relatorios} compõem o dicionário de casos de uso do sistema, que descreve as principais funcionalidades e interações dos usuários com o sistema. Cada caso de uso é detalhado com informações sobre o ator, pré-condições, fluxo principal e pós-condição.
