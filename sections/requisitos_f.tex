Os requisitos funcionais do sistema são apresentados no \autoref{quadro_requisitos_f1}, servindo de descrição das principais funcionalidades que o sistema deve oferecer.
